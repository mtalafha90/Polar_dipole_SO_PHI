...
\begin{figure*}
\centering
% Replace with the pipeline map plots for CR 2264 (baseline_outputs/milestone/):
% \includegraphics[width=\textwidth]{figures/maps_cr2264.png}
\fbox{\begin{minipage}[c][0.24\textwidth][c]{0.96\textwidth}
\centering\itshape\small
Placeholder --- upload \texttt{figures/maps\_cr2264.png} (the PHI-only, HMI-only, and merged $B_r$ Carrington maps for CR\,2264 from \texttt{baseline\_outputs/milestone/}), then uncomment the \texttt{\textbackslash includegraphics} line above.
\end{minipage}}
...
\begin{figure*}
\centering
% Replace with the pipeline map plots for CR 2297 (baseline_outputs/cr_2297/milestone/):
% \includegraphics[width=\textwidth]{figures/maps_cr2297.png}
\fbox{\begin{minipage}[c][0.24\textwidth][c]{0.96\textwidth}
\centering\itshape\small
Placeholder --- upload \texttt{figures/maps\_cr2297.png} (the PHI-only, HMI-only, and merged $B_r$ Carrington maps for CR\,2297 from \texttt{baseline\_outputs/cr\_2297/milestone/}), then uncomment the \texttt{\textbackslash includegraphics} line above.
\end{minipage}}
