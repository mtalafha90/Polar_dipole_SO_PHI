...
% aa.cls forces T1 font encoding; without scalable T1 outlines installed,
% pdflatex falls back to auto-generated low-resolution bitmap fonts for
% emphasised/italic text. lmodern supplies proper T1 outlines and keeps
% the rendered font crisp at any zoom level.
\usepackage{lmodern}
\usepackage{graphicx}
\usepackage{amsmath}
\usepackage{amssymb}
...
Figure not yet generated --- run \texttt{scripts/plot\_campaign\_summary.py}, then uncomment the \texttt{\textbackslash includegraphics} line above.
\end{minipage}}
